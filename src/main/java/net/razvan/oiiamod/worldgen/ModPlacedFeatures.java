...
public class ModPlacedFeatures {
   ...
   public static final ResourceKey<PlacedFeature> SIGMA_BERRY_BUSH_PLACE_KEY = registerKey("sigma_berry_bush_placed");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, SIGMA_BERRY_BUSH_PLACE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.SIGMA_BERRY_BUSH_KEY),
